            ...
            @for($i = 0; $i < count($history->drugs); $i++)
                <div class="sub-container">
                    ...
                    <div class="row mt-2" id="analysis_x1">
                        <div class="col-lg-3">
                            <input readonly type="text" class="form-control" name="analysis_name[]" form="patient-form" placeholder="Title">
                        </div>
                        <div class="col-lg-5 offset-lg-1">
                            <input readonly type="text" class="form-control" name="analysis_result[]" form="patient-form" placeholder="Result">
                        </div>
                    </div>
                </div>
            @endfor
